...
const legacyCategories = [
  ...
  c("crosses", "الصلبان", "صلبان اليد والصدر والمذبح والمواكب بخامات متعددة", image.cross, [["hand-crosses","صلبان يد"],["yota-medallions","الميداليات"],["pectoral-crosses","صلبان صدر"],["priest-crosses","صلبان كهنة"],["deacon-crosses","صلبان شمامسة"],["altar-crosses","صلبان مذبح"],["processional-crosses","صلبان مواكب"],["wall-crosses","صلبان حائط"],["desk-crosses","صلبان مكتب"],["car-crosses","صلبان سيارات"],["wooden-crosses","صلبان خشب"],["brass-crosses","صلبان نحاس"],["stainless-crosses","صلبان ستانلس"],["silver-crosses","صلبان فضة"],["iota-crosses","صلبان فن اليوتا"],["colored-crosses","صلبان ملونة"],["personalized-crosses","صلبان محفورة بالاسم"],["giveaway-crosses","صلبان توزيعات"],["cross-boxes","علب وحوامل الصلبان"]]),

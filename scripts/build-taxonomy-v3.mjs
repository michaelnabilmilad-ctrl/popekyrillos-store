...
const categories = [
  c("altar-vessels", "المذبح والأواني المقدسة", "أواني المذبح والذخيرة وأدوات الخدمة المقدسة", image.altar, [["altar-sets","أطقم أواني المذبح"],["chalices","الكؤوس"],["trays-stars","الصواني والنجوم"],["mystir","المستير"],["water-wine-cruets","قوارير الماء والخمر"],["relic-boxes","حق الذخيرة"],["communion-bread-boxes","بيوت القربان"],["holy-oil-vessels","أواني الميرون والزيوت"],["laqan-vessels","أواني اللقان"],["service-plates","أطباق الخدمة"],["altar-crosses","صلبان المذبح"],["altar-candlesticks","شمعدانات المذبح"],["gospel-stands","حوامل الإنجيل والبشارة"],["vessel-cases","شنط وصناديق حفظ الأواني"]]),
